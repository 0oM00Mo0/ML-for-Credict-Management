...
#读取待预测数据
pca=kernel_pca.KernelPCA(n_components=52)
pca.fit_transform(x)
pca.fit_transform(Test1)
print(np.shape(x))
...
s1=GradientBoostingClassifier(warm_start=False,max_depth=2,min_samples_split=10,loss="exponential",n_estimators=100,subsample=0.7)
