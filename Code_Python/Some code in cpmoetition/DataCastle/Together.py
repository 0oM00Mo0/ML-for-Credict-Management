...
s1=XGBClassifier(booster="gbtree",subsample=0.7,n_estimators=140,max_depth=4,gamma=0.05,reg_lambda=0.09,reg_alpha=0.09,min_child_weight=1,learning_rate=0.06)
