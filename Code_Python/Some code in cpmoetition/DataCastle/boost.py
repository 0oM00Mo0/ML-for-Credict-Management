...
s2=GradientBoostingClassifier()
s3=GradientBoostingClassifier()
s1.fit(data_resd1,rank_resed1)
s2.fit(data_resd2,rank_resed2)
s3.fit(data_resd3,rank_resed3)

test1=pd.read_excel("E:\比赛\DC新网杯\data\\test\\1.xlsx")
test2=pd.read_excel("E:\比赛\DC新网杯\data\\test\\group2.xlsx")
test3=pd.read_excel("E:\比赛\DC新网杯\data\\test\\group3.xlsx")

Test1=model1.transform(test1.iloc[:,2:])
Test2=model2.transform(test2.iloc[:,2:])
Test3=model3.transform(test3.iloc[:,2:])
'''
